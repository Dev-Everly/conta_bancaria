...
1. Clone o repositório do Projeto [Conta Bancária](https://github.com/Dev-Everly/conta_bancaria) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/Dev-Everly/conta_bancaria.git
```
...
Desenvolvido por [**Everly**](https://github.com/Dev-Everly)
